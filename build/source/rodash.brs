...
' /** TODO:
' * @name after
' * @description The opposite of rodash.before; this method creates a function that invokes func once it's called n or more times.
...
function after(n = 0 as integer, func = invalid as dynamic)
    ...
    '   if rodash.isInvalid(m[functionIdentifier]) then m[functionIdentifier] = 0
    '   rodash.nope()
    '   return func
    ' end function
...
function round(number = 0, precision = 0 as integer)
    ...
    print isNotInvalid(minor) ; minor
